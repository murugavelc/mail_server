...
function newmail_notifier_sound(){var a=rcmail.assets_path("plugins/newmail_notifier/sound"),b=navigator.mimeTypes?navigator.mimeTypes["audio/mp3"]:{},a=a+(bw.ie||b&&b.enabledPlugin?".mp3":".wav");try{var c=$("<audio>").attr("src",a);c.get(0).play()}catch(d){c=$('<embed id="sound" src="'+a+'" hidden=true autostart=true loop=false />'),c.appendTo($("body")),window.setTimeout("$('#sound').remove()",5E3)}}
