...
this.custom_menu_builder.length;f++){var h=this.custom_menu_builder[f];if(h[0](this.results[b])){k=h[1](this,g,a);break}}if(!k){var k=this.results[b].suggestions,m=this.results[b].attrs.o,f=this.results[b].attrs.l;if(this.has_dictionary&&!$(a).attr("is_corrected")){h=document.createElement("tr");var l=document.createElement("td");var n=document.createElement("span");$(n).text(this.lang_learn_word);$(l).attr("googie_action_btn","1").css("cursor","default").mouseover(c.item_onmouseover).mouseout(c.item_onmouseout).click(function(d){c.learnWord(a,
